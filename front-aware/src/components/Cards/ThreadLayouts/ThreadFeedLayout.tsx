...
import ArticleOptions from '../ArticleLayouts/ArticleOptions';
import type {ArticleFeedLayout} from '../ArticleLayouts/ArticleFeedLayout';
import TopicTag from '../Tags/TopicTag';
import CredibilityLabel from '../Tags/CredibilityLabel';

export interface ThreadFeedLayout {
    id: string;
    threadTitle: string;
    lastUpdated: string;
...
const ThreadFeed: React.FC<Props> = ({
                                         thread,
                                         threadIndex,
                                         hoveredItemId,
                                         setHoveredItemId,
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '16px'}}>
              ...
              • Last updated on {thread.lastUpdated}
                ...
                <div style={{display: 'flex', paddingLeft: '12px'}}>
                    ...
                    <div
                        style={{display: 'flex', flexDirection: 'column', gap: '16px', flex: 1, marginBottom: '-10px'}}>
